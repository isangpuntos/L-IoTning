...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>COMPATIBILITY MANAGER - <?php echo $id==""?"Add":"Edit"?> Compatibility</h2>	<p>Compatibility manager - <?php echo $id==""?"Add":"Edit"?> Compatibility</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
...
<div class="simplebox grid740" style="z-index: 720;margin:0 auto;">
                            	<div class="titleh" style="z-index: 710;">
                                	<h3><?php echo $id==""?"Add":"Edit"?> Compatibility</h3>
                                </div>
                                <div class="body" style="z-index: 690;">
                                <form action="<?php echo base_url(); ?>backend.php/cpanel/compatibility_manipulate" method="post" enctype="multipart/form-data" name="edit_user_form" id="edit_user_form" autocomplete="off"  class="form-horizontal form-row-seperated">
                                  
                                  	<div class="st-form-line" style="z-index: 680;">	
                                    	<span class="st-labeltext">Compatibility Name</span>	
                                        <input type="text" value="<?php echo isset($banners['compatibility_name'])?$banners['compatibility_name']:""; ?>" style="width:510px" id="compatibility_name" class="st-forminput" name="compatibility_name" original-title="Compatibility Name"> 
                                    ...
                                    <div class="button-box" style="z-index: 460;">
                                    	<input type="hidden" name="currentid" value="<?php echo $id;?>">
                                   	  <a href="<?php echo base_url(); ?>backend.php/cpanel/compatibility" class="button-gray">&laquo; Back</a>
