...
<head>
   ...
   <title>YUCAI GROUP Newsletter</title>
	...
	<tr>
		<td align="center" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main">
				...
				<? if(isset($title)): ?>
				<tr>
					<td align="center" class="splash">
						<table width="550" cellspacing="0" cellpadding="5">
							<tr>
								<td width="550" align="left" valign="top"><h2><?php echo $title;?></h2></td>
							</tr>
						</table>
					</td>
				</tr>
						...
						<table width="550" cellspacing="0" cellpadding="0">
							...
							<tr align="left" valign="top">
								<td valign="top" class="mainbar">
									...
									<?php $body = preg_replace('/{name}/', $name, $body); ?>
									<?php $body = preg_replace('/{email}/', $email, $body); ?>
