...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>CONTENT MANAGER</h2>	<p>License manager</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
                        ...
                        <?php if($this->session->flashdata('message')){?>
                        	...
                        	<div class="titleh">
                        	  <div class="shortcuts-icons-button" style="z-index: 450;">
                            	<a class="icon-button editbutton" href="<?php echo base_url();?>backend.php/cpanel/editlicense"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/create.png"><span>Create a New License</span></a>
                            </div>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="display data-table" id="example">             
								<thead>
									<tr>
					                    ...
					                    <th class="" rowspan="1" colspan="1" style="width: 100px;">License Name</th>
									...
									?>
									 <tr class="<?php if($i%2==0) {?>odd <?php } else {?>even<?php }?>">
				                        ...
				                        <td class="center" style="text-align:center;">
				                            <!-- Icons -->
				                            <a class="icon-button tips button-form" href="<?php echo base_url(); ?>backend.php/cpanel/editlicense/<?php echo $item['license_id']; ?>" original-title="Edit"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/create.png"></a>
						                    <a class="icon-button tips button-form" title="[Delete]" href="javascript:;" onclick="if(confirm('Do you want to delete it?')) document.location.href='<?php echo base_url(); ?>backend.php/cpanel/deletelicense/<?php echo $item['license_id']; ?>'" original-title="Delete"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/delete.png"></a>
