...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>CONTACT MANAGER</h2>	<p>Contact manager</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
							...
							<table cellpadding="0" cellspacing="0" border="0" class="display data-table" id="example">             
								<thead>
									<tr>
					                    ...
					                    <th class="" rowspan="1" colspan="1" style="width: 70px;">Date</th>
                                 ...
                                 <?php
									...
									?>
									 <tr class="<?php if($i%2==0) {?>odd <?php } else {?>even<?php }?>">
				                        ...
				                        <td style="text-align:center;"><?php echo my_int_date($item['date']); ?></td>
				                        <td class="center" style="text-align:center;">
				                            <!-- Icons -->
						                    <a class="icon-button tips button-form" title="[Delete]" href="javascript:;" onclick="if(confirm('Do you want to delete it?')) document.location.href='<?php echo base_url(); ?>backend.php/cpanel/deletesubscriber/<?php echo $item['id']; ?>'" original-title="Delete"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/delete.png"></a>
