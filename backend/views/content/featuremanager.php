...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>CONTENT MANAGER</h2>	<p>Feature manager</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
                        ...
                        <?php if($this->session->flashdata('message')){?>
                        	...
                        	<div class="titleh">
                        	  <div class="shortcuts-icons-button" style="z-index: 450;">
                            	<a class="icon-button editbutton" href="<?php echo base_url();?>backend.php/cpanel/editarticle?path=feature"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/create.png"><span>Create a New Article</span></a>
                            </div>
									...
									?>
									 <tr class="<?php if($i%2==0) {?>odd <?php } else {?>even<?php }?>">
				                        ...
				                        <td class="center" style="text-align:center;">
				                            <!-- Icons -->
				                            <a class="icon-button tips button-form" href="<?php echo base_url(); ?>backend.php/cpanel/editarticle/<?php echo $item['article_id']; ?>?path=feature" original-title="Edit"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/create.png"></a>
