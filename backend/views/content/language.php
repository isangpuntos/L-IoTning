...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>LANGUAGE MANAGER</h2>	<p>Language manager</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
                        ...
                        <?php if($this->session->flashdata('message')){?>
                        	...
                        	<div class="titleh">
                        	  <div class="shortcuts-icons-button" style="z-index: 450;">
                            	<a class="icon-button editbutton" href="<?php echo base_url();?>backend.php/cpanel/editlanguage"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/create.png"><span>Create a New Language</span></a>
                            </div>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="display data-table" id="example">             
								<thead>
									<tr>
					                    ...
					                    <th class="" rowspan="1" colspan="1" style="width: 100px;">Default</th>
                                 ...
                                 <?php
									...
									?>
									 <tr class="<?php if($i%2==0) {?>odd <?php } else {?>even<?php }?>">
				                        ...
				                        <td style="text-align:center;"><?php echo $item['sort_order']; ?></td>         
				                        <td style="text-align:center;"> <?php if ($item['default']==1) {?><img width="16" height="16" alt="icon" src="<?php echo base_url();?>assets/backend/img/icons/sidemenu/star.png"></img><?php }?></td>                  
				                        ...
				                        <td class="center" style="text-align:center;">
				                            <!-- Icons -->
				                            <a class="icon-button tips button-form" href="<?php echo base_url(); ?>backend.php/cpanel/editlanguage/<?php echo $item['language_id']; ?>" original-title="Edit"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/create.png"></a>
						                    <a class="icon-button tips button-form" title="[Delete]" href="javascript:;" onclick="if(confirm('Do you want to delete it?')) document.location.href='<?php echo base_url(); ?>backend.php/cpanel/deletelanguage/<?php echo $item['language_id']; ?>'" original-title="Delete"><img width="18" height="18" alt="icon" src="<?php echo base_url(); ?>assets/backend/img/icons/button/delete.png"></a>
