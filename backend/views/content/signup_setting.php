...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>FORM SETTING -  Signup Setting</h2>	<p>FORM SETTING -  Signup Setting Setting</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
...
<div class="simplebox grid740" style="z-index: 720;margin:0 auto;">
                            	<div class="titleh" style="z-index: 710;">
                                	<h3>FORM SETTING -  Signup Setting</h3>
                                </div>
								...
								<?php } ?>
                                    ...
                                    <div class="button-box" style="z-index: 460;">
                                      ...
                                      <input type="hidden" name="type" value="signup">
                                   	  <a href="<?php echo base_url(); ?>backend.php/cpanel/signup_setting" class="button-gray">&laquo; Back</a>
