...
function CheckAuthentication()
{
	...
	/**
	 * Find logged user in valid groups
	 * 1: admin, 2: manager
	 */
    if (isset($_SESSION['user']) || isset($_SESSION['Session_Admin'])) {
	    return true;
	}
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = substr(dirname(__FILE__), 0,strlen(dirname(__FILE__))-27).$baseUrl;
 ...
 */
    ...
    //if($_SESSION['type_folder']=='banner')
//            $config['ResourceType'][] = Array(
//				 'name' => 'Images',
//			      'url' => 'http://yucai.com.au'.$baseUrl."editor/",
//			      'directory' => $baseDir."editor/",
//			      'maxSize' => "16M",
...
//
 	if(isset($_SESSION['user']))
	{
		$config['ResourceType'][] = Array(
				'name' => 'Avatar',
				'url' => $baseUrl."users/".$_SESSION['user']['user_id']."/avatar",
				'directory' => $baseDir."users/".$_SESSION['user']['user_id']."/avatar",
				'maxSize' => 1048576,
				'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
				'deniedExtensions' => '');
		$config['ResourceType'][] = Array(
				'name' => 'Images',
				'url' => $baseUrl."users/".$_SESSION['user']['user_id']."/images",
				'directory' => $baseDir."users/".$_SESSION['user']['user_id']."/images",
				'maxSize' => 1048576,
				'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
				'deniedExtensions' => '');
		$config['ResourceType'][] = Array(
				'name' => 'Files',
				'url' => $baseUrl."users/".$_SESSION['user']['user_id']."/files",
				'directory' => $baseDir."users/".$_SESSION['user']['user_id']."/files",
				'maxSize' => 1048576,
				'allowedExtensions' => 'gzip,zip,rar',
				'deniedExtensions' => '');
	}
	 	if(isset($_SESSION['Session_Admin']))
		{
			$config['ResourceType'][] = Array(
					...
					'directory' => $baseDir,
					'maxSize' => 0,
					'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,gzip,zip,rars',
					'deniedExtensions' => '');
		}
//
//		$config['ResourceType'][] = Array(
//				'name' => 'Images',
//				'url' => $baseUrl."user/".$_SESSION['frontUser']."/images",
//				'directory' => $baseDir."user/".$_SESSION['frontUser']."/images",
//				'maxSize' => 0,
//				'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
//				'deniedExtensions' => '');
//		
